          ...
          <div className="mt-8 grid grid-cols-1 gap-8 lg:mt-0 lg:grid-cols-3 lg:gap-y-16">
            ...
            <div className="">
              ...
              <ul className="space-y-3 text-lg">
                <li>
                  <span className="mr-2"><MdOutlineEmail className="inline-flex" /> Email us:</span>
                  <a
                    href="mailto:info@ichota.com"
            ...
            <div className="">
              <p className="font-medium ">Soical Media</p>

              <ul className="mt-6 flex gap-x-5">
                <li>
                  <a
                    href="#"
                    rel="noreferrer"
